...
**
** Created: Sun Aug 20 01:20:54 2017
...
static const char qt_meta_stringdata_DisplayThread[] = {
    "DisplayThread\0\0str\0msg(QString)\0run()\0"
    "stop()\0"
};
...
int DisplayThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: msg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: run(); break;
        case 2: stop(); break;
        default: ;
        }
...
// SIGNAL 0
void DisplayThread::msg(QString _t1)
{
